...
import com.commander4j.treedoc.TreeDoc;
...
public class JLicenseInfo implements Comparable<JLicenseInfo>
{
	...
	public LinkedList<JLicenseInfo> getLicences()
	{
		...
		JLicenseInfo test = new JLicenseInfo("TreeDoc","GNU General Public License V2.txt",TreeDoc.version,"GNU General Public License V2");
